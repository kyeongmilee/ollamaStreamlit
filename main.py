...
LANGSERVE_ENDPOINT = "https://reptile-big-oriole.ngrok-free.app/llm/"
...
# 프롬프트를 자유롭게 수정해 보세요!
RAG_PROMPT_TEMPLATE = """당신은 질문에 친절하게 답변하는 AI 입니다. 검색된 다음 문맥을 사용하여 질문에 답하세요. 답을 모른다면 모른다고 답변하세요. 영어 말고 한국어로 대답해 주세요. Please answer briefly within 5 sentences.
Question: {question} 
Context: {context} 
Answer:"""
...
def embed_file(file):
    ...
    cache_dir = LocalFileStore(f"/data/home/leekyeongmi/langserve_ollama/example/.cache/embeddings/{file.name}") #/data/home/leekyeongmi/langserve_ollama/example
